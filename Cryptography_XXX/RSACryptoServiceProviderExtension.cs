...
namespace Cryptography_XXX
{
    internal static class RSACryptoServiceProviderExtension
    {
        ...
        internal static void LoadPublicKeyDER(this RSACryptoServiceProvider provider, byte[] DERData)
        {
        ...
        internal static void LoadPrivateKeyDER(this RSACryptoServiceProvider provider, byte[] DERData)
        {
        ...
        internal static void LoadPublicKeyPEM(this RSACryptoServiceProvider provider, string sPEM)
        {
        ...
        internal static void LoadPrivateKeyPEM(this RSACryptoServiceProvider provider, string sPEM)
        {
            byte[] DERData = RSACryptoServiceProviderExtension.GetDERFromPEM(sPEM);
